...
const MOCK_PEOPLE: PersonWithGraph[] = [
  {
  ...
  },
  {
    ...
    full_name: "Samantha Waite",
    first_name: "Samantha",
    last_name: "Waite",
    job_title: "Head of Post Production",
    linkedin_url: "https://linkedin.com/in/samantha-waite",
    website_url: "https://fremantle.com",
    country_code: "UK",
    city: "London",
    bio: "Oversees high-end post production workflows and color finishing for Fremantle UK.",
    profile_confidence: 96,
    ai_summary: "Head of Post at Fremantle UK.",
    provenance_type: "verified",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    positions: [
      {
        company_id: "c4",
        company_name: "Fremantle",
        company_slug: "fremantle",
        role: "head_of_post",
        seniority: "Executive",
        is_current: true,
        confidence: 96,
